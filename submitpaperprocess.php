<?php
    ...
    if(true){
        ...
        echo "Input received";
        submitPaperToDatabase($title,$author,$journal,$year,$researchMethodology,$researchMethod,$contextWhat,$contextWhy,$contextWhere,$contextWhen,$contextWho,$contextHow,$benefitOutcome,$methodResult,$methodIntegrity,$confidence,$confidenceReason,$confidenceRater);
    }else{
    ...
    function submitPaperToDatabase($title,$author,$journal,$year,$researchMethodology,$researchMethod,$contextWhat,$contextWhy,$contextWhere,$contextWhen,$contextWho,$contextHow,$benefitOutcome,$methodResult,$methodIntegrity,$confidence,$confidenceReason,$confidenceRater){
...
CREATE TABLE IF NOT EXISTS submittedPapersDemo(
    paper_id INT(10) AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(40) NOT NULL,
    author VARCHAR(40) NOT NULL,
    journal VARCHAR(40) NOT NULL,
    year INT(4) NOT NULL,
    researchMethodology VARCHAR(200) NOT NULL,
    researchMethod VARCHAR(200) NOT NULL,
...
INSERT INTO submittedPapersDemo(
    title,
    author,
    journal,
    year,
